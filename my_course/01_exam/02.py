...
while command != 'collect the nets':
    ...
    if not is_valid_location(desired_row, desired_col):
        my_location = correct_position(desired_row, N_ROWS, desired_col, N_ROWS)
        desired_row = my_location[0]
        desired_col = my_location[1]
